...
- **Suggestion chip**: shows whether Calculate as you type is on and opens [Smart chips](/smart/chips/), where the switch lives.
...
- **Suggestion chip**: shows whether Convert as you type is on and opens [Smart chips](/smart/chips/), where the switch lives.
