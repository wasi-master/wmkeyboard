...
- Every tool here has its own **Enabled** switch, and an **Icon colour** override if [colorful tool icons](/tools/overview/#browsing-every-tool) are on globally. Both live at the top of that tool's own settings screen, above everything documented in this page's Options sections.
