...
Once something is selected, the keyboard can offer what to do with it: [Selection actions](/smart/selection-actions/) puts Call, Open, QR and the case options above the keys, depending on what you selected. That bar is off by default and lives under Advanced.
